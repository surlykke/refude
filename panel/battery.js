 ...
 *
 * This array (indexed from 0 to 100 inclusive) contains the calculated angles, so if you want a segment that covers (say) 37% of the circle, you use the angle at position 37 in the array.
 */
...
export class Battery extends React.Component {
    ...
    render = () => {
        ...
        let angle = pct >= 0 && pct <= 100 ? angles[Math.round(pct)] : 0;
        ...
        let fillColor = state === "Unknown" || (state !== "Charging" && pct < 10) ? "red" : "darkgray";
