...
export class Battery extends React.Component {
    ...
    render = () => {
        ...
        let color = ["Charging", "Fully charged"].includes(state) ? "rgb(50, 50, 50)" : "rgb(150, 150, 150)";
        let dotColor =  state === "Fully charged" ? "black" : "white";

        let alert = state === "Unknown" || (state !== "Charging" && pct < 10);
        ...
        return <div title={title} style={this.props.style}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="-60 -60 120 120">
                {alert ? [
                    <circle cx="0" cy="0" r="50" stroke="red" strokeWidth="10" fill="none"/>,
                    ...
                    <circle cx="0" cy="0" r="54" stroke="black" strokeWidth="4" fill="none"/>,
                    <path d={`M 0 0 v -50 A 50 50 0 ${bigArchFlag} 0 ${archEndX} ${archEndY} L 0 0`} fill={color} stroke={color} strokeWidth="4"/>,
                    <circle cx="0" cy="0" r="22" stroke="black" strokeWidth="4" fill="none"/>,
